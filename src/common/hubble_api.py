...
class Traverser:
    ...
    @staticmethod
    def ShortPath(body, graph_id, auth=None):
        """
        最短路径
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/shortpath" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def AllShortPath(body, graph_id, auth=None):
        """
        全最短路径
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/allshortpath" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def AllPath(body, graph_id, auth=None):
        """
        全部路径
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/paths" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def KNeighbor(body, graph_id, auth=None):
        """
        k步邻居
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/kneighbor" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def CrossPoints(body, graph_id, auth=None):
        """
        交点检测
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/crosspoints" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def Rings(body, graph_id, auth=None):
        """
        环路检测
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/rings" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def NeighborRank(body, graph_id, auth=None):
        """
        NeighborRank推荐算法
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/neighborrank" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def FusiformSimilarity(body, graph_id, auth=None):
        """
        模型相似度
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/fsimilarity" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def KOut(body, graph_id, auth=None):
        """
        k跳算法
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/kout" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def CustomizedPaths(body, graph_id, auth=None):
        """
        自定义路径
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/customizedpaths" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def Rays(body, graph_id, auth=None):
        """
        射线检测
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/rays" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def WeightedShortPath(body, graph_id, auth=None):
        """
        带权最短路径
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/weightedshortpath" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def SingleShortPath(body, graph_id, auth=None):
        """
        单源带权最短路径
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/singleshortpath" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def JaccardSimilarity(body, graph_id, auth=None):
        """
        Jaccard相似度
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/jaccardsimilarity" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def PersonalRank(body, graph_id, auth=None):
        """
        PersonalRank推荐算法
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/personalrank" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res

    @staticmethod
    def SameNeighbors(body, graph_id, auth=None):
        """
        共同邻居
        :param body:
        :param auth:
        ...
        :return:
        """
        url = "/api/v1.2/graph-connections/%d/job-manager/%d/algorithms/sameneighbors" % graph_id
        code, res = Request().request(method='post', path=url, json=body, types="hubble")
        return code, res
