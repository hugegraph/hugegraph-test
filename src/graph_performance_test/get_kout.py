...
# graph12_url = 'http://xxx-sw-scylladb01.xxx.xxx.xxx:8585/graphs/hugegraph/traversers/kout?source=%d&direction=BOTH&max_depth=3'
# graph11_url = 'http://xxx-sw-scylladb01.xxx.xxx.xxx:8761/graphs/hugegraph/traversers/kout?source=%d&direction=BOTH&max_depth=3'
...
graph_dict = {
    'graph12': 'xxx-sw-scylladb01.xxx.xxx.xxx:8585',
    'graph11': 'xxx-sw-scylladb01.xxx.xxx.xxx:8761'
}
