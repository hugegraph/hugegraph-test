...
class TestHubbleNeighborRank(unittest.TestCase):
    """
    hubble的NeighborRank推荐算法API
    """
    ...
    def test_neighborRank(self):
        ...
        code, res = Traverser.NeighborRank(body=body, graph_id=graph_id)
        print(code, res)
        self.assertEqual(code, 200, "响应状态码不正确")
        self.assertEqual(res['status'], 200, "NeighborRank算法返回状态码不正确")
