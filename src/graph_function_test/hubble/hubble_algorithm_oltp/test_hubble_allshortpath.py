...
class TestHubbleAllShortPath(unittest.TestCase):
    """
    hubble的全最短路径算法API
    """
    ...
    def test_normal(self):
        ...
        code, res = Traverser.AllShortPath(body=body, graph_id=graph_id)
        print(code, res)
        self.assertEqual(code, 200, "响应状态码不正确")
        self.assertEqual(res['status'], 200, "全最短路径算法返回状态码不正确")
