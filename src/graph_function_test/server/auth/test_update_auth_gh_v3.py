...
from src.common.server_api import AuthGHV3
...
class TestCommonAuth(unittest.TestCase):
    ...
    def test_status_read(self):
        ...
        user_id = set_auth_gh.post_auth_v3(permission_list)

        # check auth
        code, res = AuthGHV3().get_users_role(user_id, auth=user)
        print(code, res)
        for key, value in res['roles'][_cfg.graph_space][_cfg.graph_name].items():
        ...
        self.assertEqual(
            res,
            {'name': _cfg.graph_name, 'backend': _cfg.server_backend, 'description': ''},
            'Authorize result check fail'
        )

        # check Unauthorized'
        body = 'NONE'
        code, res = Graph().put_graphs_mode(body=body, auth=_cfg.test_password)
        print(code, res)
    ...
    def test_status_write(self):
        ...
        body = 'NONE'
        code, res = Graph().put_graphs_mode(body=body, auth=user)
        print(code, res)
        self.assertEqual(code, 403, 'Authorize code check fail')
        ...
        self.assertEqual(res, {'name': _cfg.graph_name, 'backend': _cfg.server_backend, 'description': ''})
    ...
    def test_propertyKey_read(self):
        ...
        code, res = Schema().create_property(body=body, auth=user)
        print(code, res)
        self.assertEqual(code, 403, 'Unauthorized code check fail')
        self.assertEqual(
            res['message'],
        ...
        name = 'test_name'
        code, res = Schema().delete_property_by_name(name=name, auth=user)
        print(code, res)
        self.assertEqual(code, 403, 'Unauthorized code check fail')
        self.assertEqual(
            res['message'],
    ...
    def test_vertexLabel_read(self):
        ...
        code, res = Schema().create_vertexLabel(body=body, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='Unauthorized code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
        ...
        # check Unauthorized--delete
        name = 'person'
        code, res = Schema().delete_vertexLabel(name=name, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='Unauthorized code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
    ...
    def test_edgeLabel_read(self):
        ...
        code, res = Schema().create_edgeLabel(body=body, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='Unauthorized code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
        ...
        # check Unauthorized--delete
        name = 'link'
        code, res = Schema().delete_edgeLabel(name=name, auth=user)
        self.assertEqual(code, 403, msg='Unauthorized code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
    ...
    def test_edgeLabel_delete(self):
        ...
        Schema().create_edgeLabel(body=body, auth=auth)
    ...
    def test_indexLabel_vertex_read(self):
        ...
        code, res = Schema().create_index(body=body, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='Unauthorized code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
        ...
        # check Unauthorized--delete
        name = 'personByAge'
        code, res = Schema().delete_index(name=name, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='Unauthorized code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
    ...
    def test_indexLabel_vertex_write(self):
        ...
        for key, value in res['roles'][_cfg.graph_space][_cfg.graph_name].items():
            if key == 'WRITE':
                ...
                self.assertEqual(len(value), 2, msg='role type check fail')
    ...
    def test_vertex_read(self):
        ...
        v_id = '\"1:marko\"'
        code, res = Vertex().get_vertex_by_id(v_id=v_id, auth=user)
        print(code, res)
        self.assertEqual(code, 200, msg='Authorize code check fail')
        ...
        code, res = Edge().get_edge_by_id(e_id=e_id, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
        ...
        code, res = Vertex().create_single_vertex(body=body, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')

        # check unAuthorize-- delete
        code, res = Vertex().delete_vertex(v_id=v_id, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
    ...
    def test_vertex_write(self):
        ...
        # check unAuthorize--read
        code, res = Vertex().get_vertex_by_id(v_id='\"1:marko\"', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')

        # check unAuthorize--delete
        code, res = Vertex().delete_vertex(v_id='1:alg', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
    ...
    def test_vertex_delete(self):
        ...
        code, res = Vertex().delete_vertex(v_id='\"1:marko\"', auth=user)
        print(code, res)
    ...
    def test_edge_read(self):
        ...
        # check Authorize--read
        code, res = Edge().get_edge_by_id(e_id='S1:marko>1>>S1:vadas', auth=user)
        print(code, res)
        self.assertEqual(code, 200, msg='Authorize code check fail')
        ...
        code, res = Edge().create_single_edge(body=body, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')

        # check unAuthorize-- edge delete
        code, res = Edge().delete_edge(e_id='S1:marko>1>>S1:vadas', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
    ...
    def test_var_read(self):
        ...
        # premise
        name = 'var'
        code, res = Variable().put_var(body={'data': 'test'}, name=name, auth=auth)
        print(code, res)
        ...
        # check Authorize--read
        code, res = Variable().get_var(key=name, auth=auth)
        print(code, res)

        code, res = Variable().get_var(key=name, auth=user)
        print(code, res)
        ...
        code, res = Variable().put_var(body=body, name='name', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(
            res['message'],
        ...
        # check unAuthorize--delete
        code, res = Variable().delete_var(name='name', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(
            res['message'],
    ...
    def test_task_read_execute_grants(self):
        ...
        # admin 用户创建task
        gremlin = '1+1'
        code, res = Gremlin().gremlin_job(query=gremlin, auth=auth)
        print(code, res)
        self.assertEqual(code, 201, msg='unAuthorize code check fail')
        self.assertEqual(res['task_id'], 1, msg='unAuthorize code check fail')
    ...
    def test_task_execute_write_delete(self):
        ...
        code, res = Task().delete_task(task_id='1', auth=user)
        print(code, res)
        self.assertEqual(code, 204, msg='Authorize code check fail')
    ...
    def test_target_read(self):
        ...
        # check Authorize--read
        code, res = AuthGHV3().get_targets(auth=user)
        print(code, res)
        self.assertEqual(code, 200, msg='Authorize code check fail')
        ...
        code, res = AuthGHV3().post_targets(body, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(
            res['message'],
        ...
        # check unAuthorize--delete
        code, res = AuthGHV3().delete_targets('-77:target_read_target', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(
            res['message'],
    ...
    def test_target_write(self):
        ...
        # check unAuthorize--delete
        code, res = AuthGHV3().delete_targets('-77:gremlin', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(
            res['message'],
    ...
    def test_target_delete(self):
        ...
        # check Authorize--delete
        code, res = AuthGHV3().delete_targets('-77:target_delete_target', auth=user)
        print(code, res)
        self.assertEqual(code, 204, msg='Authorize code check fail')
    ...
    def test_all_read(self):
        ...
        # check unAuthorize--delete
        code, res = Vertex().delete_vertex(v_id='\"1:josh\"', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
    ...
    def test_all_write(self):
        ...
        # check unAuthorize--read
        code, res = Vertex().get_vertex_by_id(v_id='\"1:josh\"', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(res['message'], 'User not authorized.', msg='Unauthorized result check fail')
    ...
    def test_all_delete(self):
        ...
        code, res = AuthGHV3().delete_targets('-77:all_delete_target', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='Authorize code check fail')
    ...
    def test_grant_read(self):
        ...
        # check Authorize--read
        code, res = AuthGHV3().get_accesses(auth=user)
        print(code, res)
        self.assertEqual(code, 200, msg='unAuthorize code check fail')

        # check unAuthorize--write
        body = {'group': '-69:gremlin', 'target': '-71:gremlin', 'access_permission': 'EXECUTE'}
        code, res = AuthGHV3().post_accesses(body, auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')

        # check unAuthorize--delete
        code, res = AuthGHV3().delete_accesses('S-69:grant_read_group>-88>11>S-77:grant_read_target', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
    ...
    def test_grant_write_exclude_grants(self):
        ...
        code, res = AuthGHV3().post_groups(body, auth=user)
        print(code, res)
        self.assertEqual(code, 201)
    ...
    def test_grant_write_contain_grants(self):
        ...
        # check unAuthorize--delete
        code, res = AuthGHV3().delete_accesses('S-69:gremlin>-88>18>S-77:gremlin', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
        self.assertEqual(
            res['message'],
    ...
    def test_grant_delete_exclude_grants(self):
        ...
        code, res = AuthGHV3().post_targets(body, auth=auth)
        print(code, res)

        body = {"group_name": "gremlin", "group_description": "group can execute gremlin"}
        code, res = AuthGHV3().post_groups(body, auth=auth)
        print(code, res)

        body = {'group': '-69:gremlin', 'target': '-77:gremlin', 'access_permission': 'EXECUTE'}
        code, res1 = AuthGHV3().post_accesses(body, auth=auth)
        print(code, res)
        self.assertEqual(code, 201, msg='unAuthorize code check fail')
        ...
        user_id = set_auth_gh.post_auth_v3(permission_list)
        code, res = AuthGHV3().get_users_role(user_id, auth=auth)
        print(code, res)
        for key, value in res['roles'][_cfg.auth_graph].items():
            if key == 'READ':
                self.assertIn(value[0]['type'], 'GRANT', msg='role type check fail')
        ...
        code, res = AuthGHV3().delete_accesses(res1['id'], auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='Authorize code check fail')
        self.assertEqual(
            res['message'],
    ...
    def test_userGroup_read(self):
        ...
        # check Authorize--read
        code, res = AuthGHV3().get_groups(auth=user)
        print(code, res)
        self.assertEqual(code, 200, msg='unAuthorize code check fail')
        ...
        # check unAuthorize--delete
        code, res = AuthGHV3().delete_groups('-69:userGroup_read_group', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
    ...
    def test_userGroup_write(self):
        ...
        # check unAuthorize--delete
        code, res = AuthGHV3().delete_groups('-69:gremlin', auth=user)
        print(code, res)
        self.assertEqual(code, 403, msg='unAuthorize code check fail')
    ...
    def test_userGroup_delete(self):
        ...
        # check Authorize--delete
        code, res = AuthGHV3().delete_groups('-69:userGroup_delete_group', auth=user)
        print(code, res)
        self.assertEqual(code, 204, msg='Authorize code check fail')
...
class User(unittest.TestCase):
    ...
    def test_user_create(self):
        ...
        code, res = AuthGHV3().post_users(body, auth=auth)
        print(code, res)
        self.assertEqual(code, 201, msg='code check fail')
        self.assertEqual(res['id'], 'tester', 'res check fail')
    ...
    def test_user_delete(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().delete_users(res['id'], auth=auth)
        print(code, res)
    ...
    def test_user_list(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().get_users(auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(len(res['users']), 2, 'res check fail')
        if res['users'][0]['user_name'] == 'tester':
            self.assertEqual(res['users'][0]['id'], 'tester')
        else:
            self.assertEqual(res['users'][1]['id'], 'tester')
    ...
    def test_user_one(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().get_user(res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['id'], 'tester', 'res check fail')
    ...
    def test_user_one_role(self):
        ...
        self.assertEqual(
            res['roles'],
            {_cfg.graph_space: {_cfg.graph_name: {'WRITE': [{'type': 'GRANT', 'label': '*', 'properties': None}]}}},
            'res check fail'
        )
    ...
    def test_user_update(self):
        ...
        code, res = AuthGHV3().update_users(body, res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
...
class Groups(unittest.TestCase):
    ...
    def test_groups_delete(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().delete_groups(res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 204, msg='code check fail')
    ...
    def test_groups_list(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().get_groups(auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['groups'][0]['id'], 'gremlin', 'res check fail')
    ...
    def test_groups_one(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().get_group(res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['id'], 'gremlin', 'res check fail')
    ...
    def test_groups_update(self):
        ...
        code, res = AuthGHV3().update_groups(body, res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
...
class Target(unittest.TestCase):
    ...
    def test_target_delete(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().delete_targets(res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 204, msg='code check fail')
    ...
    def test_target_list(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().get_targets(auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['targets'][0]['id'], 'gremlin', 'res check fail')
    ...
    def test_target_one(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().get_target(res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['id'], 'gremlin', 'res check fail')
    ...
    def test_target_update(self):
        ...
        code, res = AuthGHV3().update_targets(body, res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
...
class Access(unittest.TestCase):
    ...
    def teardown_class(self):
        ...
        """
        # # 删除资源
        # code, res = AuthGHV3().delete_targets('gremlin', auth=auth)
        # print(code, res)
        # # 删除用户组
        # code, res = AuthGHV3().delete_groups('gremlin', auth=auth)
        # print(code, res)
    ...
    def setUp(self):
        ...
        :resurn:
        """
        code, res = AuthGHV3().delete_accesses('gremlin->8->gremlin', auth=auth)
        print(code, res)
    ...
    def test_access_create(self):
        ...
        创建 access
        """
        body = {'group': 'gremlin', 'target': 'gremlin', 'access_permission': 'EXECUTE'}
        code, res = AuthGHV3().post_accesses(body, auth=auth)
        print(code, res)
        self.assertEqual(code, 201, msg='code check fail')
        self.assertEqual(res['id'], 'gremlin->8->gremlin', 'res check fail')
    ...
    def test_access_delete(self):
        ...
        code, res = AuthGHV3().post_accesses(body, auth=auth)
        # test
        code, res = AuthGHV3().delete_accesses(res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 204, msg='code check fail')
    ...
    def test_access_list(self):
        ...
        code, res = AuthGHV3().post_accesses(body, auth=auth)
        # test
        code, res = AuthGHV3().get_accesses(auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['accesses'][0]['id'], 'gremlin->8->gremlin', 'res check fail')
    ...
    def test_access_one(self):
        ...
        code, res = AuthGHV3().post_accesses(body, auth=auth)
        # test
        code, res = AuthGHV3().get_access(res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['id'], 'gremlin->8->gremlin', 'res check fail')
    ...
    def test_access_update(self):
        ...
        code, res = AuthGHV3().update_accesses(body, res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['id'], 'gremlin->8->gremlin', 'res check fail')
...
class Belongs(unittest.TestCase):
    ...
    def teardown_class(self):
        ...
        """
        # 删除用户
        code, res = AuthGHV3().delete_users("tester", auth=auth)
        print(code, res)
        # 删除用户组
        code, res = AuthGHV3().delete_groups('gremlin', auth=auth)
        print(code, res)
    ...
    def setUp(self):
        ...
        :resurn:
        """
        code, res = AuthGHV3().delete_belongs('tester->gremlin', auth=auth)
        print(code, res)
    ...
    def test_belong_create(self):
        ...
        创建 belong
        """
        body = {'group': 'gremlin', 'user': 'tester', 'belong_description': 'belong gremlin'}
        code, res = AuthGHV3().post_belongs(body, auth=auth)
        print(code, res)
        self.assertEqual(code, 201, msg='code check fail')
        self.assertEqual(res['id'], 'tester->gremlin', 'res check fail')
    ...
    def test_belong_delete(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().delete_belongs(res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 204, msg='code check fail')
    ...
    def test_belong_list(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().get_belongs(auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['belongs'][0]['id'], 'tester->gremlin', 'res check fail')
    ...
    def test_belong_one(self):
        ...
        print(code, res)
        # test
        code, res = AuthGHV3().get_belong(res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['id'], 'tester->gremlin', 'res check fail')
    ...
    def test_belong_update(self):
        ...
        code, res = AuthGHV3().update_belongs(body, res['id'], auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['id'], 'tester->gremlin', 'res check fail')
...
class Token(unittest.TestCase):
    ...
    def test_login_token(self):
        ...
        生成 token
        """
        body = {'user_name': 'admin', 'user_password': _cfg.admin_password['admin']}
        code, res = AuthGHV3().post_token(body, auth=auth)
        print(code, res)
        x = res["token"]
        # print(x)
        # print(type(x))
    ...
    def test_verify_token(self):
        ...
        code, res = AuthGHV3().get_verify(header=h, auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        self.assertEqual(res['user_name'], 'admin')
        self.assertEqual(res['user_id'], 'admin')

    def test_token_expire(self):
        """
        生成 token 设置token过期时间120s
        """
        body = {'user_name': 'admin', 'user_password': _cfg.admin_password['admin'], 'token_expire': '120'}
        code, res = AuthGHV3().post_token(body, auth=auth)
        print(code, res)
        self.assertEqual(code, 200, msg='code check fail')
        x = res["token"]
        ...
        code, res = AuthGHV3().get_verify(header=h, auth=auth)
        print(code, res)
        self.assertEqual(code, 401, msg='code check fail')
        self.assertEqual(res['message'], 'The token is expired')
    ...
    def test_ordinary_verify_token(self):
        ...
        self.assertEqual(res['user_id'], 'tester')
