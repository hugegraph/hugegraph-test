...
def test_create_property_single_text():
    ...
    code, res = Schema().create_property(body=body, auth=auth)
    print(code, res)
    assert code == 202
...
def test_append_userdata():
    ...
    code, res = Schema().deal_property_userdata(name="age", param={"action": "append"}, body=body, auth=auth)
    assert code == 202
    assert res['property_key']["user_data"]["min"] == 0
...
def test_eliminate_userdata():
    ...
    code, res = Schema().deal_property_userdata(name="age", param={"action": "eliminate"}, body=body, auth=auth)
    print(code, res)
    assert code == 202
...
def test_get_property_by_name():
    ...
    code, res = Schema().get_property_by_name(name='age', auth=auth)
    print(code, res)
    assert code == 200
    assert res['name'] == 'age'
...
def test_delete_property_by_name():
    ...
    code, res = Schema().delete_property_by_name(name='age', auth=auth)
    print(code, res)
    assert code == 202
