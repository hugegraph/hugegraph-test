...
server_gen_dir = f'hugegraph/hugegraph-server/apache-hugegraph-server-{is_incubating}{server_release_version}'
...
server_tar_path = os.path.join(codebase_path, 'hugegraph/hugegraph-server', f'apache-hugegraph-server-{is_incubating}{server_release_version}' + '.tar.gz')
